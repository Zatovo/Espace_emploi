...
<html lang="fr">
    ...
    <body>
        <div class="container">
            ...
            <main>
                <!--Eto daholo ny offre rehetra mipoitraaaaaaaaaaaaaaaaaaa-->
                    <h1>Mes offres</h1>
                    ...
                    <div class="publications-container">
                        <div class="publication-box">
                            ...
                            <p><strong>Description :</strong> Lorem, ipsum dolor sit amet consectetur adipisicing elit. Enim quos maxime quas, dolore rerum iusto sit nemo totam laboriosam placeat fugit est expedita porro cumque, quod, tempora veritatis tenetur! Omnis!</p>
                        ...
                        <div class="publication-box">
                            ...
                            <p><strong>Description :</strong> Lorem ipsum dolor sit amet consectetur adipisicing elit. Obcaecati fugiat, dolorum veritatis ducimus cupiditate cum earum repellendus sunt reiciendis blanditiis quibusdam corrupti. Incidunt reprehenderit, ea blanditiis totam veniam possimus eaque.</p>
                        ...
                        <div class="publication-box">
                            ...
                            <p><strong>Description :</strong> Lorem ipsum dolor sit, amet consectetur adipisicing elit. Quaerat soluta minima exercitationem qui, ab voluptatum temporibus quisquam fuga facere! Ex, consectetur repudiandae. Sequi dolor vitae explicabo possimus dolorem non facilis!</p>
                        ...
                        <div class="publication-box">
                            ...
                            <p><strong>Description :</strong> Lorem ipsum dolor sit amet consectetur adipisicing elit. Ad delectus quod voluptates velit laudantium temporibus dolore blanditiis? Iure explicabo aut, cum porro excepturi nihil voluptas veritatis, error autem iusto accusantium.</p>
                    ...
                    <h2>Pas encore d'Offre disponible. Revenez une autre fois merci!</h2>
            </main>
            <div class="right">
                <div class="top">
                    <button id="menu-btn">
                    ...
                    <div class="profile">
                        <div class="info">
                            <p>Salut chers</p>
                                <small class="text-muted"><b>Candidat</b></small>
                        </div>
                ...
                <!--END OF TOP-->
                <!--===========================Historique de candidature nataony Candidat 5 ihany no apotra max donc manao condition zany dia rehefa miclique an'io izy dia rediriger ary amny historiqueny===================================-->
                <div class="sales-analytics">
                    <h2>Historique de candidature</h2>
                    ...
                    <!--==================================SI PAS ENCORE D'Historique(condition zany azafady)=========================-->
                <h2>Pas encore d'historique de candidature. Veuillez Postuler</h2>
                </div>
            </div>
        </div>
    </body>
